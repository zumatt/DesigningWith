            ...
            elements: (
              <>
                <div className="flex flex-col gap-2">
                  ...
                  <h2 className="bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_30px_30px_rgba(1,1,1,0)] shadow-[#8CD782] rounded-2xl px-4 py-6 ">1.1 Categories of Knowledge Dimensions</h2>
                  ...
                  <h2 className="bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_30px_30px_rgba(1,1,1,0)] shadow-[#8CD782] rounded-2xl px-4 py-6 ">1.2 Categories of Cognitive Processes</h2>
                  <div className="flex flex-col md:flex-row px-4 py-6 bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white rounded-2xl gap-[14px]">
                    <div className="flex flex-col md:w-1/2">
                      <p className=" md:text-[29px]">
                  ...
                  <h2 className="bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_30px_30px_rgba(1,1,1,0)] shadow-[#8CD782] rounded-2xl px-4 py-6 ">1.3 Towards Educational Objectives and Instructional Activities</h2>
                  ...
                  <h2 className="flex w-full bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_30px_30px_rgba(1,1,1,0)] shadow-[#8CD782] rounded-2xl px-4 py-6 ">1.4 The framework of Bloom's taxonomy table</h2>
                  <div className="flex flex-col px-4 py-6 bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white rounded-2xl w-full gap-4">
                    ...
                    <div className="flex flex-col w-full gap-2">
                      <div className="flex flex-row w-full gap-2">
                        <p className=" w-2/5 h-full md:h-auto md:w-1/4 rounded-lg border bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white md:text-[22px] p-4 md:p-4 border-green">The knowledge dimension</p>
                        <div className="flex flex-col w-3/5 md:w-3/4 gap-2">
                          <p className=" w-full sm:h-full md:h-auto rounded-lg border bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-4 border-green">The cognitive process dimension</p>
                          <div className="hidden md:flex flex-row w-full gap-2">
                            <p className=" w-1/6 rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(1) Remember</p>
                            <p className=" w-1/6 rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(2) Understand</p>
                            <p className=" w-1/6 rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(3) Apply</p>
                            <p className=" w-1/6 rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(4) Analyze</p>
                            <p className=" w-1/6 rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(5) Evaluate</p>
                            <p className=" w-1/6 rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white  p-2 border-green">(6) Create</p>
                          </div>
                      ...
                      <div className="flex flex-row gap-2 w-full">
                        <div className="flex flex-col gap-2 w-full">
                          <div className="flex flex-row w-full gap-2">
                            <p className="w-2/5 md:w-1/4 rounded-lg border bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white md:text-[22px] p-2 border-green">(a) Factual Knowledge</p>
                          ...
                          <div className="flex flex-row w-full gap-2">
                            <p className="w-2/5 md:w-1/4 rounded-lg border md:text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(b) Conceptual Knowledge</p>
                            <div className="hidden md:flex w-3/5 md:w-3/4 flex flex-row gap-2">
                              <p className=" w-1/6 h-full rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green"></p>
                              <p className=" w-1/6 h-full rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green"></p>
                              <p className=" w-1/6 h-full rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green"></p>
                          ...
                          <div className="flex flex-row w-full gap-2">
                            <p className="w-2/5 md:w-1/4 rounded-lg border md:text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(c) Procedural Knowledge</p>
                            <div className="hidden md:flex w-3/5 md:w-3/4 flex flex-row gap-2">
                              <p className=" w-1/6 h-full rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green"></p>
                              <p className=" w-1/6 h-full rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green"></p>
                              <p className=" w-1/6 h-full rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green"></p>
                          ...
                          <div className="flex flex-row w-full gap-2">
                            <p className="w-2/5 md:w-1/4 rounded-lg border md:text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(d) Meta Knowledge</p>
                            <div className="hidden md:flex w-3/5 md:w-3/4 flex flex-row gap-2">
                              <p className=" w-1/6 h-full rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green"></p>
                              <p className=" w-1/6 h-full rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green"></p>
                              <p className=" w-1/6 h-full rounded-lg border text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green"></p>
                        ...
                        <div className="flex md:hidden flex-col w-full -rotate-90 gap-2">
                            <p className=" w-full rounded-lg border md:text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(1) Remember</p>
                            <p className=" w-full rounded-lg border md:text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(2) Understand</p>
                            <p className=" w-full rounded-lg border md:text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(3) Apply</p>
                            <p className=" w-full rounded-lg border md:text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(4) Analyze</p>
                            <p className=" w-full rounded-lg border md:text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(5) Evaluate</p>
                            <p className=" w-full rounded-lg border md:text-[22px] bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white p-2 border-green">(6) Create</p>
                        </div>
                      </div>
                    </div>
                    <p className=" mt-6 md:w-1/2"> Starting from this table, we established the educational objectives and the instructional activities that structure the didactic guidelines. A table for each specific teaching module is available to download from the “Didactic guidelines in practice” section.</p>
                  </div>
                </div>
              </>
            ),
