      ...
      <div className="bg-[#D9D9D9] bg-opacity-50 shadow-[inset_0_0_20px_5px_rgba(1,1,1,0)] shadow-white px-4 py-6 rounded-b-2xl">
        ...
        <div className="flex flex-col md:flex-row justify-between md:gap-[14px] mt-[50px]">
          ...
          <p className="flex-1">
            ...
            we first make clear what is meant by input and output data. 
          </p>
        </div>
      </div>
    </div>
  ...
  extra: (
    ...
    <h2 className="p-4 rounded-2xl mb-2" style={{boxShadow: "0px 0px 100px 5px #FFFFFF inset", backgroundColor: "#72DAFB"}}>
      ...
      <div className="flex flex-col md:flex-row justify-between md:gap-[14px] glassBox p-4 rounded-2xl">
        ...
        category, video, and structured. These categories
        are classified as elementary data{" "}
          <AdditionalInformations small={true} information="including numerical, textual, image, audio and category data" />{" "}
          representing a single unorganised data type, or composite data{" "}
        ...
        to their status: raw data when used as input to an AI system,
        and cooked data when processed as output by an AI system.
        </p>
        <p className="flex-1">
        Based on these four formalised poles – elementary data,
        composite data, raw data, cooked data – and on the seven
